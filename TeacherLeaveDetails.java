...
class TeacherLeaveDetails extends JFrame implements ActionListener
{
    ...
    String[] getEmpIDNoFromDB()
    {
        ...
        try 
        {
            ...
            String selectQuery="select DISTINCT empId from teacherleave;";
    ...
    public void TeacherLeaveDetailsTable() 
    {
        try 
        {
            Class.forName("com.mysql.cj.jdbc.Driver");
            c = DriverManager.getConnection("jdbc:mysql://localhost:3306/universitymanagementsystem", "root", "root");
            st=c.createStatement();
            String selectQuery="select *from teacherleave where empId='"+(String)rollNoComboBox.getSelectedItem()+"';";
            rs=st.executeQuery(selectQuery);  
