...
class ViewStudentDetails extends JFrame implements ActionListener
{
    JComboBox rollNoComboBox;
    JTable table;
    JButton searchBtn, printBtn, updateBtn,addBtn, backBtn;
    JLabel searchLabel;
    String[] rollNoList;
    ResultSet rs;
    Connection c;
    ...
    {
        this.setLayout(null);
        searchLabel=new JLabel("Select Rollno to Search:");
        ...
        searchBtn.setBounds(500,50,120,30);
        ...
        // backBtn.setBounds(640,120,100,30);
    ...
    public void StudentDetailsTable() 
    {
        try 
        {
            ...
            String selectQuery="select *from student where rollNo='"+(String)rollNoComboBox.getSelectedItem()+"';";
